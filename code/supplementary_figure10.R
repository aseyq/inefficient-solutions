...
ggsave("output/supplementary_figure10.png", combined_a10, width = fig.width, height = fig.height, dpi = 300)
ggsave("output/supplementary_figure10.pdf", combined_a10, width = fig.width, height = fig.height, device = grDevices::cairo_pdf)
ggsave("output/supplementary_figure10.svg", combined_a10, width = fig.width, height = fig.height, device = svglite::svglite)
