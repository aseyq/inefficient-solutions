...
FigA11a <- (plot_score_treatment("low_appeal") / plot_score_treatment("high_appeal")) +
...
FigA11b <- (plot_cost_treatment("low_appeal") / plot_cost_treatment("high_appeal")) +
  plot_layout(guides = "collect") &
  theme(legend.position = "none")
...
# Combined figure
FigA11 <- wrap_plots(
  wrap_elements(FigA11a),
  wrap_elements(FigA11b),
  ncol = 1
) +
