...
ggsave("output/supplementary_figure11.png", plot = FigA11, width = fig.width, height = fig.height, dpi = 300)
ggsave("output/supplementary_figure11.pdf", plot = FigA11, width = fig.width, height = fig.height, device = grDevices::cairo_pdf)
ggsave("output/supplementary_figure11.svg", plot = FigA11, width = fig.width, height = fig.height, device = svglite::svglite)
