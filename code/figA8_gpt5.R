...
input_path <- "data/df_advice_gpt5.csv"
...
message("Please note that GPT5 systematically overestimates the mix_nutrients category. See comparison metrics for details.")
ggsave("figures/figA8_gpt5.png", plot = FigA8, width = 11.5, height = 6, dpi = 300)
