...
ggsave("output/supplementary_figure12.png", plot = FigA12, width = fig.width, height = fig.height, dpi = 300)
ggsave("output/supplementary_figure12.pdf", plot = FigA12, width = fig.width, height = fig.height, device = grDevices::cairo_pdf)
ggsave("output/supplementary_figure12.svg", plot = FigA12, width = fig.width, height = fig.height, device = svglite::svglite)
