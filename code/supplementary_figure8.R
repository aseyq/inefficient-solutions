...
ggsave("output/supplementary_figure8.png", plot = FigA8, width = fig.width, height = fig.height, dpi = 300)
ggsave("output/supplementary_figure8.pdf", plot = FigA8, width = fig.width, height = fig.height, device = grDevices::cairo_pdf)
ggsave("output/supplementary_figure8.svg", plot = FigA8, width = fig.width, height = fig.height, device = svglite::svglite)
