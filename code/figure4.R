...
figure4 <- ggplot(cum_all, aes(x = rank, y = cum_prop, colour = treatment, group = treatment)) +
...
ggsave("output/figure4.png", plot = figure4, width = fig.width, height = fig.height, dpi = 300)
ggsave("output/figure4.pdf", plot = figure4, width = fig.width, height = fig.height, device = grDevices::cairo_pdf)
